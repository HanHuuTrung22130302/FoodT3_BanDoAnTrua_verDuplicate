...
public class AjaxOrderController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (OrderInvoice oi : ois) {
            ...
            out.println("  <td class='money'>" + oi.getTotalAmount() + "</td>");
            ...
            out.println("          <div class='buttonSubmitCheck'>");
            ...
            for (OrderInvoiceDetail item : oi.getOrderInvoiceDetail()) {
                ...
                out.println("            <div class='product-total'><div class='money'>" + item.getTotalAmount() + "&nbsp;đ</div></div>");
                out.println("          </div>");
            }

            out.println("            <div class='line_end'></div>");
            out.println("            <div class='order-total'>Tổng tiền: <span class='total-money' style='font-size: 22px'>" + oi.getTotalAmount() + "&nbsp;đ</span></div>");
            out.println("          </div>");
            out.println("        </div></div></div>");
            out.println("  </td>");
            out.println("</tr>");
