    ...
    <div class="form-container sign-up-container">
        <form action="signup" method="post">
            ...
            <div class="social-container">
                ...
                <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://foodt3.online/loginGoogle&response_type=code&client_id=165264526065-7cooqsg6h3rda6ouocf2aq0fvqi5fcjh.apps.googleusercontent.com&approval_prompt=force" class="social">
